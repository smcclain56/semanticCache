...
public class VAL_CompressionMain {
	public static void main(String[] args){
		...
		VALCompressor c = new VALCompressor(new VALDeterminer(),w);
		//Compressor c = new Compressor(new TestMultSegDet(),w);
		int sizeInBits = 0;
		int i =0;
		try{
			WriteCompressedColumn wcc = new VALBinaryColumnWriter("C:\\Jason\\Research\\Bitmap\\TestDataSet\\Compressed\\", "test3");
			...
			CompressedBitmapReader cbr = new VALCompressedReader();
			for(int z = 0; z<i; z++){
