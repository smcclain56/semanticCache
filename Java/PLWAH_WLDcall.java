...
public class PLWAH_WLDcall {
	...
	public static void main(String[] args){
		...
		PLWAHCompressor c = new PLWAHCompressor(VLCConstants.RAW_TABLE);
		int sizeInBits =0;
		
		int i = 0;
		try{
			//This will write the compressed files in binary form
			WriteCompressedColumn wcc = new PLWAHBinaryColumnWriter(VLCConstants.outDir,VLCConstants.outFileExtension);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			String myAlgo = "algo_PLWAH";
            VLCConstants.expResults.put(WLD_QueryMain.recordCount+","+"PLWAH"+","+VLCConstants.OPT_SIZE+","+myAlgo,
            		"PLWAH"+","+sizeInBytes+","+totalTime);
