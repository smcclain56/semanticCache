...
public class PLWAHBinaryColumnWriter implements WriteCompressedColumn {
	 ...
	 * when it is written. 
	 * */
	public PLWAHBinaryColumnWriter(String outFolder, String filePrefix)throws IOException{
	...
	public void writeColumn(ActiveBitCollection col) throws IOException {
			...
			int seglen = VLCConstants.WORD_LEN;
