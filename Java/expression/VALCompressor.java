...
public class VALCompressor {
	 ...
	 * */
	public VALCompressor(SegmentationLengthDeterminer sld, BitStringRep[] table){
		this.sld = sld;
		this.table = table;
	...
	public ActiveBitCollection compress(int columnNum){ 
		...
		ActiveBitCollection columnRep = new VALActiveBitCollection(seglen,""+columnNum);
		...
		//This is needed for VAL to ensure the last active word is written
		((VALActiveBitCollection)columnRep).finishColumn();
		return columnRep;
